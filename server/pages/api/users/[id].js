...
function handler(req, res) {
  ...
  function getUserById() {
    const user = helpers__WEBPACK_IMPORTED_MODULE_0__[/* usersRepo */ "b"].getById(req.query.id);
    return res.status(200).json(user);
  }

  function updateUser() {
    try {
      helpers__WEBPACK_IMPORTED_MODULE_0__[/* usersRepo */ "b"].update(req.query.id, req.body);
  ...
  function deleteUser() {
    helpers__WEBPACK_IMPORTED_MODULE_0__[/* usersRepo */ "b"].delete(req.query.id);
    return res.status(200).json({});
  }
}
